...
from PySide.QtCore import QPoint, QRect, QSize
from PySide.QtCore import QPointF, QRectF, QSizeF
from PySide.QtGui import QColor, QTransform, QStyle, qRgb

from ui.color_picker_ui import Ui_ColorPicker as UI
...
class ColorPreviewWidget( QtGui.QWidget ):
	originalColorClicked = QtCore.Signal()
...
class ColorPlaneWidget( QtGui.QWidget ):
	valueXChanged = QtCore.Signal( float )
	valueYChanged = QtCore.Signal( float )
	valueZChanged = QtCore.Signal( float )
