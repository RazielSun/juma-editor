...
##----------------------------------------------------------------##
class GenericVecFieldEditor( FieldEditor ):
...
##----------------------------------------------------------------##
class Vec2FieldEdtior( GenericVecFieldEditor ):
	def getDimension( self ):
		return 2
...
##----------------------------------------------------------------##
class Vec3FieldEdtior( GenericVecFieldEditor ):
	def getDimension( self ):
		return 3
...
##----------------------------------------------------------------##
class Vec4FieldEdtior( GenericVecFieldEditor ):
	def getDimension( self ):
		return 4
