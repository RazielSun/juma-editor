...
def AKUModulesContextInitialize():
    ...
    cmoai.AKUCTUtilContextInitialize()
    ...
    cmoai.AKUImageJpgContextInitialize()
    cmoai.AKUImagePngContextInitialize()
    cmoai.AKUImagePvrContextInitialize()
    cmoai.AKUImageWebPContextInitialize()
