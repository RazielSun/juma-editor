...
cdef extern from "ct-util/host.h":
...
cdef extern from "moai-image-jpg/host.h":
    void            AKUImageJpgContextInitialize      ()

cdef extern from "moai-image-png/host.h":
    void            AKUImagePngContextInitialize      ()

cdef extern from "moai-image-pvr/host.h":
    void            AKUImagePvrContextInitialize      ()

cdef extern from "moai-image-webp/host.h":
...
cdef extern from "moai-sim/MOAIKeyCodeEnum.h":
    # TODO: support keycode remap
    cdef int    MOAI_KEY_SHIFT
    cdef int    MOAI_KEY_CONTROL
    cdef int    MOAI_KEY_ALT
